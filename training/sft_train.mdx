...
<ParamField path="data_from_hf" type="boolean">
  A flag to determine whether to load data from Hugging Face. _Set to `True` by default._
</ParamField>

<ParamField path="do_split" type="boolean">
  A flag to determine whether to split the dataset into training and validation sets. _Set to `True` by default._
</ParamField>
